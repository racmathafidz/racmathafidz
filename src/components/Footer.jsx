...
import {
  Container, Spacer, Row, Col, Text, Link, Grid,
      ...
      <Fade bottom delay={600}>
        <Grid.Container gap={2} justify="flex-start">
          <Grid xs={isMobile ? '12' : '8'} sm={8}>
            <Col>
              <Text weight="normal" css={{ fontSize: '2rem' }}>Get in touch</Text>
              <Text weight="light" css={{ fontSize: '18px' }}>
                ...
                <Link
                  ...
                  css={{
                    textGradient: '112deg, #AAFFEC -63.59%, #ff4ecd -20.3%, #0070F3 70.46%',
                  }}
                >
          ...
          <Grid xs={isMobile ? '12' : '4'} sm={4}>
            <Row justify={isMobile ? 'flex-start' : 'flex-end'} align="flex-end">
              <a
