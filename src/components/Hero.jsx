    ...
    >
      ...
      <Fade bottom delay={300}>
        <Grid.Container gap={2} justify="center" direction={isTab ? 'column-reverse' : 'row'}>
          <Grid xs={12} sm={8}>
            <Col>
              ...
              <Text
                ...
                css={{ fontSize: '$sm' }}
              >
                I'm a Full-Stack Developer who loves to create good performance and beautiful websites.
                {' '}
          ...
          <Grid xs={12} sm={4} css={{ display: 'flex', justifyContent: isTab ? 'center' : 'flex-end', alignSelf: 'center' }}>
