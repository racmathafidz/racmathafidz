          ...
          <Grid xs={12} sm={8}>
            <Col>
              ...
              <Text
                ...
                css={{ fontSize: '$sm' }}
              >
                I'm a fullstack engineer who love to create good performance and beautiful website.
                {' '}
                I have a strong passion for web technology such as Javascript (ES6), React, React Native, Next, Node, Express, MongoDB, Firebase, Redux, and many more.
                Also, I'm interested in learning and exploring new things.
              </Text>
              <Spacer y={0.9} />
              <Row>
                <Button
